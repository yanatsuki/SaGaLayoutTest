//
//  条件変化スキル＆アイテム ver1.03
//
// author yana
//

var Imported = Imported || {};
Imported['ConditionallyChangeSkill'] = 1.03;

/*:
 * @plugindesc ver1.03/条件を満たすと別のスキルやアイテムに変化するスキルやアイテムを作成できます。
 * @author Yana
 * 
		...
		if (currentAction) {
			...
			if (cItem && !this.flashSkill(cItem)) {
				...
				if (!(action.isForAll() || action.isForRandom())) {
					action.setTarget(currentAction.targetIndex);
				}
